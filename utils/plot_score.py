...
plt.plot(max_list1, label='final_epsilon=1e-4')
plt.plot(max_list2, label='final_epsilon=1e-2')
plt.xlabel('Episodes')
plt.ylabel('Scores')
plt.title('Max Scores of double dqn (every 20 episodes)')
plt.legend()
plt.savefig('../img/double_dqn/max_scores.png')
plt.clf()

plt.plot(mean_list1, label='final_epsilon=1e-4')
plt.plot(mean_list2, label='final_epsilon=1e-2')
plt.xlabel('Episodes')
plt.ylabel('Scores')
plt.legend()
plt.title('Mean Scores of double dqn (every 20 episodes)')
plt.savefig('../img/double_dqn/mean_scores.png')
plt.clf()

plt.plot(median_list1, label='final_epsilon=1e-4')
plt.plot(median_list2, label='final_epsilon=1e-2')
plt.xlabel('Episodes')
plt.ylabel('Scores')
plt.legend()
